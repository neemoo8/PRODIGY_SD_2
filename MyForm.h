...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Tahoma", 9, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::Moccasin;
			this->label1->Location = System::Drawing::Point(4, 124);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(228, 19);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Guess the number between 1 and 100";
			...
			this->textBox1->Location = System::Drawing::Point(7, 183);
